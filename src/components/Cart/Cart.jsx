                  ...
                  <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                                  ...
                                  <div className="flex flex-1 items-end justify-between text-sm">
                                    ...
                                    <div className="flex">
                                      <button
                                        ...
                                        onClick={product.count > 1 ? () => dispatch(minusItem(product.id)) : () => dispatch(removeItem(product.id)) }
                                        type="button"
                                        className="font-large pr-4 text-4xl text-rose-300 hover:text-rose-200"
                                      >
                                        -
                                      </button>
                    ...
                    <div className="border-t border-gray-200 py-6 px-4 sm:px-6">
                      ...
                      <div className="mt-6">
                        <a
                          href="#"
                          className="flex items-center justify-center rounded-md border border-transparent bg-rose-400 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-rose-400"
                        >
                          Checkout
                        </a>
                      </div>
